...
values('metadata.broker.list', 'server-1:9092,server-2:9092,server-4:9092', 'kafka broker服务器', 0, null, 1, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('zookeeper.connect', 'server-1:2181,server-2:2181,server-3:2181', 'zookeeper服务器', 0, null, 1, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('kafka.path', '/', 'kafka 目录', 0, null, 1, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('zookeeper.sync.time.ms', '200', 'zookeeper同步时间(ms)', 0, null, 1, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('auto.commit.interval.ms', '1000', 'zookeeper自动提交时间(ms)', 0, null, 1, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('zookeeper.session.timeout.ms', '30000', 'zookeeper会话超时(ms)', 0, null, 1, 'admin', 'admin', now(), now());

insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('ud1.customer.threadnum', '3', 'Ud1数据处理线程数', 0, null, 1, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('radius.customer.threadnum', '3', 'Radius数据处理线程数', 0, null, 1, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('message.customer.threadnum', '3', '消息数据处理线程数', 0, null, 1, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('jobstatus.monitor.threadNum', '3', 'job任务状态监控线程数', 0, null, 1, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('jobstatus.monitor.intervalTime', '3', 'job任务状态监控扫描时间间隔（单位秒）', 0, null, 1, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('jobstatus.monitor.sleepTime', '60', 'job 任务状态监控异常线程休眠时间(单位秒)', 0, null, 1, 'admin', 'admin', now(), now());

insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('hdfs.warehouse', '/user/hive/warehouse/zf.db/', 'hdfs路径', 0, null, 1, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('ud1.hdfs.maxrecord', '50000', 'UD1写HDFS文件记录数', 0, null, 1, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('ud1.hdfs.timeout', '30', 'UD1写HDFS超时时间（秒）', 0, null, 1, 'admin', 'admin', now(), now());

insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('policy_dpi', '3,0,30', 'DPI策略超时设置', 0, null, 1, 'admin', 'admin', now(), now());

insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('system.deploy.mode', '1', 'DPI网路模式', 3, '0,汇聚网络\n1,独立网络', 1, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
...
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('azkaban.url', 'http://192.168.5.101:8081', 'azkaban URL', 0, null, 1, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('azkaban.username', 'azkaban', 'azkaban用户名', 0, null, 1, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('azkaban.password', 'azkaban', 'azkaban密码', 1, null, 1, 'admin', 'admin', now(), now());

insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('monitor.file.received.timeout', '300', '文件接收超时阀值(秒)', 0, null, 1, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('monitor.file.upload.timeout', '300', '文件上报超时阀值(秒)', 0, null, 1, 'admin', 'admin', now(), now());



------------
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('push.type', '1', '告警推送类型', 4, '1,邮件\n2,微信', 2, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('push.url', 'http://192.168.4.238:8089/zfpush', '警告信息推送接口', 0, null, 2, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('push.url.ack', 'http://192.168.4.238:8895/zfpushack', '警告信息推送返回ACK接口', 0, null, 2, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('push.mail.receiver', '', '告警邮件接收人', 0, null, 2, 'admin', 'admin', now(), now());
insert into zf_dict_system_config(config_key,config_value,config_desc,input_type,input_items,model_type,CREATE_OPER,MODIFY_OPER,CREATE_TIME,MODIFY_TIME)
values('push.wechat.receiver', '', '警告微信接收人', 0, null, 2, 'admin', 'admin', now(), now());
